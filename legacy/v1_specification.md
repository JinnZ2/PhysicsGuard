...
>
> This is the original PhysicsGuard README, which carried the entire v1
> implementation inline as pasted source. Every module here was extracted into
> real files (`b3f06e6`) and then rewritten (`92cefb1`). The code below no longer
> matches the codebase, and its verdict thresholds (`SUSPECT < 0.5`,
> `CORRUPTED >= 0.5`) were retuned to `0.3`.
>
> Kept as evidence for falsifications **F-001**, **F-002** and **F-003** in
> [`../FALSIFICATION_LOG.md`](../FALSIFICATION_LOG.md).
